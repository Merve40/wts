export class Table{
    ...
    public static STUDENT_FAHIGKEIT="Student_Fähigkeit";
    public static STUDENT_LEIDENSCHAFT="Student_Leidenschaft";
    ...
    public static KONTAKTANFRAGE:string="Kontaktanfrage";
